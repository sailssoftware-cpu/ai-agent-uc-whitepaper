        ...
        <div className="my-8 p-6 bg-white border border-slate-200 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-4">
                ...
                <div className="flex flex-col justify-around text-center font-bold text-sm text-slate-600">
                    <div className="h-1/3 flex items-center justify-center">HIGH IMPACT</div>
                    <div className="h-1/3 flex items-center justify-center">MEDIUM IMPACT</div>
                    <div className="h-1/3 flex items-center justify-center">LOW IMPACT</div>
                </div>
