    ...
    return (
        <div className="my-8 p-6 bg-white border border-slate-200 rounded-lg shadow-sm overflow-x-auto">
            ...
            <div className="min-w-[600px]">
                <div className="grid grid-cols-4 gap-4 pb-3 border-b-2 border-slate-300 text-sm font-bold text-slate-800">
                    <div>USE CASE</div>
                ...
                <div className="divide-y divide-slate-200 text-sm">
                 ...
                 <div className="mt-6 pt-4 border-t-2 border-[#064a70] text-center">
                    <p className="font-bold text-slate-800">Total Annual Impact: $7.4M cost savings + $12M+ fraud prevention</p>
                </div>
            </div>
        </div>
    );
